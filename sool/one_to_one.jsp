...
<!-- 애매 -->
    ...
    <form name="myForm" action="h" method="post" >
        <fieldset>
            <legend>검색폼</legend> 
...
<div class="content"> 
	...
	<div class="cs_menu_box">
		<h2>고객센터</h2>
		<ul class="sub_menu">
<li><a href="<%=cp %>/homesool/csCenter.com">공지사항</a></li>
<li><a href="<%=cp %>/homesool/one_to_one.com" class="active">1:1문의하기</a></li>			
<li><a href="<%=cp %>/homesool/faq.com">FAQ</a></li>
		</ul>
	</div>
	<!-- //sub_menu_box -->

	<div align="left"><h1>1:1문의</h1></div>
    <br/><br/>	
	...
	<table>
		...
		<tbody>
			<tr>
				<th scope="row">제목</th>
				<td width="970" height="86" >
					<input type="text" name="bor_subject" size="60" maxlength="100" />
				</td>
			</tr>
			<tr>
				<th scope="row">아이디</th>
				...
				maxlength="20" 
				value="${sessionScope.customInfo.user_id }"/>
				</td>
			</tr>
			<tr>
				<th scope="row">내용</th>
				<td width="970" height="86" >
					<textarea rows="12" cols="63" name="bor_content"></textarea>
				</td>
			</tr>
		</tbody>
	</table>
